...
func NewServer(dest net.Destination, dispatcher routing.Dispatcher, ns *NameServer) (Server, error) {
...
func NewClient(
	...
	err := core.RequireFeatures(ctx, func(dispatcher routing.Dispatcher) error {
		...
		server, err := NewServer(ns.Address.AsDestination(), dispatcher, ns)
		if err != nil {
