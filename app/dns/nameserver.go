...
func NewServer(dest net.Destination, dispatcher routing.Dispatcher, queryStrategy QueryStrategy, ns *NameServer) (Server, error) {
...
func NewClient(
	...
	err := core.RequireFeatures(ctx, func(dispatcher routing.Dispatcher) error {
		...
		server, err := NewServer(ns.Address.AsDestination(), dispatcher, ns.GetQueryStrategy(), ns)
		if err != nil {
